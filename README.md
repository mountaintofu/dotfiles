...
> <b>Must be done</b> before fully installing the system onto disk. For easy setup, use ![archinstall](https://archinstall.archlinux.page/) available on Arch Linux live environment, don't forget to ![connect to the internet](https://wiki.archlinux.org/title/Installation_guide?pubDate=20251202#Connect_to_the_internet).
