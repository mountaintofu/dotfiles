...
- <ins>xfce4-panel</ins>, custom <ins>genmon</ins> ("<ins>Gen</ins>eric <ins>Mon</ins>itor") scripts (![windowTitle.sh](	/../main/config/genmon/windowTitle.sh), ![vtec.sh](	/../main/config/genmon/vtec.sh), ![batteryBar.sh](	/../main/config/genmon/batteryBar.sh), ![presentationMode.sh](	/../main/config/genmon/presentationMode.sh)).
...
- <ins>tlp</ins> (default=_auto_) + <ins>cpupower-gui</ins> (default=_Bottle_*) for _v-tec.sh_ (Performance/Bottle mode).
